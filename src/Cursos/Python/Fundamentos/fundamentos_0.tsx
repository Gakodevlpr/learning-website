...
const Fundamentos = () => {
    return (
        <div>
            ...
            <div id='content_fundamentos0' className="flex flex-col gap-[22px] text-white text-justify">
                ...
                <p id='presentation'>
                    ...
                    <span className='relative group inline-block'>
                        <a href="https://code.visualstudio.com/" className="text-black font-bold hover:text-red-800">
                        ...
                        <span className="absolute left-[-10] sm:left-0 -right-0 sm:right-auto mt-6 w-44 sm:w-58 p-4 bg-white/50 backdrop-blur-lg rounded-xl shadow-lg border border-gray-200 opacity-0 scale-0 transform transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 z-10">
                            ...
                            <h3 className="text-xl sm:text-lg font-semibold mb-2 text-black text-center sm:text-left">Web oficial de Visual Studio Code</h3>
                            <p className="text-sm text-gray-800">Descarga el instalador desde esta web.</p>
                        </span>
                    </span>
                    &nbsp;, pero puedes usar cualquier otro que te guste. <br />
                        Una vez instalado, te sugiero que veas este pequeño tutorial oficial de 7 minutos que es una guía para novatos&nbsp;
                        <a href="https://www.youtube.com/watch?v=T1nHfZ-Z0-8" className="text-black font-bold hover:text-red-800">
                            <i className='bx bx-chevrons-right'></i>
                ...
                <p id='python_installer'>
                    ...
                    <span className="relative group inline-block">
                        <a href="https://www.python.org/downloads/" aria-label="Web oficial de Python" className="text-black font-bold hover:text-red-800">
                            <i className='bx bx-chevrons-right'></i>
                            Python
                            <i className='bx bx-chevrons-left'></i>
                        </a>
                        <span className="absolute left-[-10] sm:left-0 -right-0 sm:right-auto mt-6 w-44 sm:w-58 p-4 bg-white/50 backdrop-blur-lg rounded-xl shadow-lg border border-gray-200 opacity-0 scale-0 transform transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 z-10">
                            ...
                            <h3 className="text-xl sm:text-lg font-semibold mb-2 text-black text-center sm:text-left">Web oficial de Python</h3>
                            <p className="text-sm text-gray-800">Descarga el instalador desde esta web.</p>
                        </span>
                    </span>
                </p>
                <p id='list_components'>
                    ...
                    <ul className='list-disc list-inside px-4 py-2'>
                        ...
                        <li className='justify-start'>Varias herramientas básicas (pip, IDLE -Integrated Development and Learning Environment-, etc).</li>
                    </ul>
                </p>
                <p id=''>
                </p>
